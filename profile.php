...
<h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-500 text-center mb-4 sm:mb-6">User Profile</h1>
<div class="bg-gray-800 p-4 sm:p-6 lg:p-8 rounded-lg shadow-xl w-full max-w-xl mx-auto min-w-0">
    <?php if ($user_info): ?>
        <div class="space-y-6">
            ...
            <div class="space-y-4 border-t border-gray-700 pt-6">
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    <i class="fa-solid fa-user text-blue-500 text-xl sm:text-2xl shrink-0 mt-1 sm:mt-0"></i>
                    <div class="min-w-0">
                        <p class="text-gray-400">Username</p>
                        <p class="text-white text-lg sm:text-xl font-semibold break-anywhere"><?php echo htmlspecialchars($user_info['username']); ?></p>
                    </div>
                </div>
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    <i class="fa-solid fa-envelope text-blue-500 text-xl sm:text-2xl shrink-0 mt-1 sm:mt-0"></i>
                    <div class="min-w-0">
                        <p class="text-gray-400">Email</p>
                        <p class="text-white text-lg sm:text-xl font-semibold break-anywhere"><?php echo htmlspecialchars($user_info['email']); ?></p>
                    </div>
                </div>
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    <i class="fa-solid fa-user-tag text-blue-500 text-xl sm:text-2xl shrink-0 mt-1 sm:mt-0"></i>
                    <div class="min-w-0">
                        <p class="text-gray-400">Role</p>
                        <p class="text-white text-lg sm:text-xl font-semibold"><?php echo htmlspecialchars(ucfirst($user_info['role'])); ?></p>
                    </div>
                </div>
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    <i class="fa-solid fa-calendar-alt text-blue-500 text-xl sm:text-2xl shrink-0 mt-1 sm:mt-0"></i>
                    <div class="min-w-0">
                        <p class="text-gray-400">Member Since</p>
                        <p class="text-white text-base sm:text-xl font-semibold break-anywhere"><?php echo date('F j, Y, g:i a', strtotime($user_info['created_at'])); ?></p>
                    </div>
                </div>
            </div>
...
<div id="cropper-modal" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 hidden p-4">
    <div class="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-lg mx-auto modal-safe">
        <h2 class="text-xl font-bold text-white mb-4">Adjust Profile Picture</h2>
        <div class="w-full cropper-preview-area mb-4">
...
<div id="confirm-modal" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 hidden p-4">
    <div class="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-sm mx-auto modal-safe">
...
<div id="image-preview-modal" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 hidden p-4">
    <div class="relative inline-block p-2 rounded-lg">
        <button id="close-preview-btn" class="absolute top-3 right-3 text-white bg-gray-800 rounded-full p-2 hover:bg-gray-700 transition-colors duration-300 focus:outline-none">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
        </button>
		<img id="modal-image"
     src=""
     alt="Profile Picture Preview"
     class="block max-w-[90vw] max-h-[90vh] object-contain rounded-lg">
    </div>
</div>
