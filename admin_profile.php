...
<div class="admin-page-inner admin-page-inner--narrow">
<h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-500 text-center mb-4 sm:mb-6">Admin Profile</h1>
<div class="bg-gray-800 p-4 sm:p-6 lg:p-8 rounded-lg shadow-xl w-full min-w-0">
            ...
            <div class="space-y-4 border-t border-gray-700 pt-6">
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-white text-lg sm:text-xl font-semibold break-anywhere"><?php echo $admin_username; ?></p>
                    </div>
                </div>
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-white text-lg sm:text-xl font-semibold break-anywhere"><?php echo $admin_email; ?></p>
                    </div>
                </div>
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-white text-lg sm:text-xl font-semibold"><?php echo ucfirst($role); ?></p>
                    </div>
                </div>
                <div class="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-white text-base sm:text-xl font-semibold break-anywhere"><?php echo $admin_created_at; ?></p>
                    </div>
                </div>
            </div>
        </div>
